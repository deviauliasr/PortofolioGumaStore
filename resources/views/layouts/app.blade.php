...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" href="{{ url('frontend/css/main-Copy.css') }}">
<!--===============================================================================================-->
</head>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						Jalan-jalan ke cikini, Yuk habiskan uang mu disini ! XD
					</div>
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						?>
							...
							<div class="icon-header-item">  
								...
								<div class="icon-header-noti" data-notify="{{ $barang_cust }}">
								@endif
									<a class="cl2 hov-cl1 trans-04 p-l-22 p-r-11 zmdi zmdi-shopping-cart" href="cart"></a>
								</div>
							</div>
